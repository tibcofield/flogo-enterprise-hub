...
| Demo | About |
|------|-------|
| [customer-health-monitor](./customer-health-monitor/README.md) | Demo showcasing Flogo's Model Context Protocol (MCP) integration with data from Salesforce, Google Sheets and Postgres |
